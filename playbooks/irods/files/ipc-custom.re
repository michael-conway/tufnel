...
acCreateCollByAdmin(*ParColl, *ChildColl) {
  applyAllRules(acCreateCollByAdminRules(*ParColl, *ChildColl), 0, 0);
}
...
acDeleteCollByAdmin(*ParColl, *ChildColl) {
  applyAllRules(acDeleteCollByAdminRules(*ParColl, *ChildColl), 0, 0);
}
...
acPostProcForPut { applyAllRules(acPostProcForPutRules, 0, 0); }
acPostProcForPutRules {
  or { ipc_acPostProcForPut; }
#  or { bisque_acPostProcForPut; }
#  or { aegis_acPostProcForPut; }
}

acPostProcForCopy { ipc_acPostProcForCopy; }

acPostProcForCollCreate { applyAllRules(acPostProcForCollCreateRules, 0, 0); }
acPostProcForCollCreateRules {
  or { ipc_acPostProcForCollCreate; }
#  or { bisque_acPostProcForCollCreate; }
#  or { coge_acPostProcForCollCreate; }
}
...
acPostProcForObjRename(*SourceObject, *DestObject) {
  applyAllRules(acPostProcForObjRenameRules(*SourceObject, *DestObject), 0, 0);
}
acPostProcForObjRenameRules(*SourceObject, *DestObject) {
  or { ipc_acPostProcForObjRename(*SourceObject, *DestObject); }
#  or { coge_acPostProcForObjRename(*SourceObject, *DestObject); }
}
